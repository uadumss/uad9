...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <a class="btn btn-outline-info text-dark shadow-sm" href="<?php echo e(url('listar autoridades/')); ?>">Listar autoridades</a>
                        ...
                        <table class="table table-sm table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php $__currentLoopData = $autoridad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="<?php echo e(url('/hab_autoridad/'.$a['cod_aut'].'/t')); ?>" class="btn btn-light btn-circle btn-sm text-danger" title="Deshabilitar autoridad"> <i class="fas fa-user-lock"></i>
                                        </a>
...
<?php echo $__env->make('marco/pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/resoluciones/autoridad/l_desHab_autoridad.blade.php ENDPATH**/ ?>