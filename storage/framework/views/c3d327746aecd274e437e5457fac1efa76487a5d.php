            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="input-group">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear tramite - srv')): ?>
                        <a href="#" class="btn btn-outline-info btn-sm text-dark m-1 pt-1 shadow-sm" data-target="#Tramite" data-toggle="modal"
                           onclick="cargarDatos('<?php echo e(url("fe_tramite/L/0")); ?>','panel_tramite')">
                            +  Legalización</a>
                                ...
                                <?php $__currentLoopData = $tramites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <td class="text-left">
                                                ...
                                                ?>
                                                <span class="font-italic font-weight-bold rounded pl-2 pr-2 <?php echo e($tipo_tramite[$t['tre_tipo'].'C']); ?>">
                                                <?php echo e($tipo_tramite[$t['tre_tipo']]); ?>

                                            </span>
                                        </td>
                                        <td class="text-left"><?php echo e($t['tre_nombre']); ?> </td>
                                        <td><?php echo e($t['tre_numero_cuenta']); ?></td>
                                        <td class="text-left"><?php echo e(strtoupper($t['tre_buscar_en'])); ?></td>

                                        <td class="text-left"><?php echo e($t['tre_duracion']); ?></td>
                                        <td class="text-right"><?php echo e($t['tre_costo']); ?> Bs.</td>

                                        <td class="text-right">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar tramite - srv')): ?>
                                                <a href="#" class="btn btn-light btn-circle btn-sm text-primary" data-target="#Tramite" data-toggle="modal"
                                                   onclick="cargarDatos('<?php echo e(url("fe_tramite/".$t["tre_tipo"]."/".$t["cod_tre"])); ?>','panel_tramite')"
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <a href="#" class="btn btn-light btn-circle btn-sm text-dark" data-target="#Tramite" data-toggle="modal"
                                                   onclick="cargarDatos('<?php echo e(url("l_glosa/".$t["cod_tre"])); ?>','panel_tramite')"
                                                   title="Glosas"><i class="fas fa-align-justify"></i>
                                                </a>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('habilitar tramite - srv')): ?>
                                                    <a href="<?php echo e(url('habilitar tramite/'.$t['cod_tre'])); ?>" class="btn btn-light btn-circle btn-sm" title="Habilitar legalización">
                                                        <?php if($t['tre_hab']=='t'): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar tramite - srv')): ?>
                                                <a class="btn btn-light btn-circle btn-sm text-danger" data-target="#Tramite" data-toggle="modal"
                                                   onclick="cargarDatos('<?php echo e(url("f_eli_tramite/".$t['cod_tre'])); ?>','panel_tramite')"
...
<?php echo $__env->make('marco/pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pc\Desktop\V2\uad9\resources\views/servicios/tramite/l_legalizacion.blade.php ENDPATH**/ ?>