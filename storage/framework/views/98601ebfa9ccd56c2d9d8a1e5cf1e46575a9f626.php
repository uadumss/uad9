        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php if(Auth::user()->foto!=''): ?>
                    <img class="img-profile rounded-circle" src="<?php echo e(url('img/foto/'.Auth::user()->foto)); ?>">
                <?php else: ?>
                    <img class="img-profile rounded-circle" src="<?php echo e(url('img/icon/fotoM.png')); ?>">
                <?php endif; ?>
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item text-primary" href="<?php echo e(url('rendimiento/1/'.Auth::user()->id)); ?>" title="Rendimiento">
                    <i class="fas fa-chart-line"></i> Rendimiento
                </a>
                <?php endif; ?>

                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-primary" href="<?php echo e(url('editar datos personles/'.Auth::user()->id)); ?>" title="Rendimiento">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-white" id="exampleModalLabel">Cerrar session</h5>
            ...
            <div class="modal-body">
                <div class="font-weight-bold alert-danger shadow text-center centrar_bloque col-md-8 p-2" id="eliTomo">
                    Realmente desea cerrar session?
                </div>
            </div>
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/marco/cuenta.blade.php ENDPATH**/ ?>