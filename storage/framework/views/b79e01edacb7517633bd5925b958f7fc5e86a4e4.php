    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 alert-primary">
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php if($des['des_hab']=='t'): ?>
                        <?php if($tarea['tar_inf_final']=='t' || $tarea['tar_hab']=='f' ): ?>
                        ...
                        <?php else: ?>
                            <a href="#" class="float-right d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-3" data-target="#reporte" data-toggle="modal"
                               onclick="cargarDatos('<?php echo e(url("f_reporte_conclusion/".$tarea["cod_tar"])); ?>','panel_reporte')">
                                + Reportar conclusión</a>
                        <?php endif; ?>

                        <?php if($tarea['tar_concluido']=='t' || $tarea['tar_hab']=='f'): ?>
                            <div class="float-right d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm mr-3">
                                 Tarea concluida </div>
                        <?php else: ?>
                            <a href="#" class="float-right d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-3" data-target="#reporte" data-toggle="modal"
                                onclick="cargarDatos('<?php echo e(url("f_editar_reporte/0/".$tarea["cod_tar"])); ?>','panel_reporte')">
                                + Reportar diario </a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                            ...
                            <table class="table table-sm ml-4 mr-2">
                                <tr>
                                    <td colspan="2"> <span class="text-primary font-weight-bolder">Tarea:</span><br/>
                                        <span class="text-dark font-weight-bolder"><?php echo e($tarea['tar_nombre']); ?></span>
                                    </td>
                                </tr>
                                <tr>

                                    <td> <span class="text-primary font-weight-bolder">Fecha de inicio: </span><br/>
                                        <span class="text-dark font-weight-bolder"><?php echo e(date('d/m/Y',strtotime($tarea['tar_fi']))); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <?php $__currentLoopData = $diario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if($d->dia_corregir=='t'): ?>
                                                        ...
                                                        <a href="#" class="btn btn-light btn-sm btn-circle text-danger" data-target="#reporte" data-toggle="modal"
                                                           onclick="cargarDatos('<?php echo e(url('listar observaciones tarea/'.$d->cod_dia)); ?>','panel_reporte')">
                                                ...
                                                <td>
                                                    <?php if($tarea['tar_con']=='t' || $des['des_con']=='t' || $d->dia_aceptado=='t' || $d->dia_corregir!='f' ): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="#" class="btn btn-light btn-circle btn-sm text-danger" data-target="#reporte" data-toggle="modal"
                                                            onclick="cargarDatos('<?php echo e(url("f_eliminar_diario/".$d->cod_dia)); ?>','panel_reporte')">
...
<?php echo $__env->make('marco/pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uad9\resources\views/actividad/reporte/registro_diario.blade.php ENDPATH**/ ?>