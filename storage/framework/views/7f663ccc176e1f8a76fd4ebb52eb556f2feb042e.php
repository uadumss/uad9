            ...
            <div class="row">
                    ...
                    <div class="input-group">
                        <div class="float-left ">
                            <div class="input-group">
                                ...
                                <input class="form-control form-control-sm" type="date" name="fecha" onchange="$(location).attr('href','<?php echo e(url("listar tramite apostilla/")); ?>'+'/'+this.value);" />
                            </div>
                        </div>&nbsp;&nbsp;|&nbsp;&nbsp;
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear trámite - apo')): ?>
                            <?php if($fecha==(date('Y-m-d'))): ?>
                                <a class="btn btn-outline-info btn-sm text-dark shadow-sm" data-target="#apostilla" data-toggle="modal"
                                   onclick="cargarDatos('<?php echo e(url('editar tramite apostilla/0')); ?>','panel_apostilla');">
                                     + Apostilla</a>
                                <span style="font-size: 1.5em" class="text-gray-500">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('importar trámite - apo')): ?>
                                <a class="btn btn-outline-info btn-sm text-dark shadow-sm" data-target="#apostilla" data-toggle="modal">
                                    + Importar trámite</a>
                                <span style="font-size: 1.5em" class="text-gray-500">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                        <?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group float-left">
                        <a haref="#" class="btn btn-sm btn-primary text-white" onclick="cargarDatos('<?php echo e(url('formulario busqueda apostilla')); ?>','panel_apostilla')" data-toggle="modal" data-target="#apostilla">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <?php if($t->apos_estado==1): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <?php if($t->apos_estado==2 || $t->apos_estado==3): ?>
...
<?php echo $__env->make('marco/pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uad9\resources\views/apostilla/tramite/l_tramite_apostilla.blade.php ENDPATH**/ ?>