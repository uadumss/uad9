        ...
        <div id="collapsethree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" overflow>
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <div class="dropright">
                    ...
                    <a class="collapse-item" href="<?php echo e(url('reportes resoluciones')); ?>"><i class="fas fa-chart-area"></i> Reportes</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <li class="nav-item">
            ...
            <div id="collapsedya" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('listar universidades - dya')): ?>
                    <a class="collapse-item" href="<?php echo e(url('listar universidades')); ?>"><i class="fas fa-graduation-cap"></i> Universidades</a>
                    <?php endif; ?>
                </div>
            </div>
        </li>
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/marco/menu.blade.php ENDPATH**/ ?>