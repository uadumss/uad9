<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content border-bottom-danger">
                            ...
                            <div>
                                <table class="text-dark col-md-12" >
                                    <tr>
                                        ...
                                        <th class="text-dark text-left border-bottom border-danger pl-3"><?php echo e($glosa->glo_titulo); ?></th>
                                    </tr>
                                    <tr>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-danger" type="button" data-dismiss="modal" onclick="enviar('form_eliminar_glosa','<?php echo e(url('eliminar_glosa')); ?>','panel_tramite')">Aceptar</button>
            </div>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/tramite/f_eli_glosa.blade.php ENDPATH**/ ?>