...
<div class="modal-content border-bottom-danger shadow-lg">
    <form action="<?php echo e(url('eli_traleg')); ?>" method="post">
        <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <table class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom border-dark">
                                        <?php echo e(date('y/m/Y', strtotime($tramita->tra_fecha_solicitud))); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom border-dark">
                                        <?php echo e($tramita->per_apellido." ".$tramita->per_nombre); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom border-dark">
                                        ...
                                        ?>
                                        <span class="font-weight-bold rounded pl-2 pr-2 <?php echo e($tipo_tramite[$tramita->tra_tipo_tramite.'C']); ?>" style="font-size: 0.75em">
                                                <?php echo e($tipo_tramite[$tramita->tra_tipo_tramite]); ?>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/tra_legalizacion/f_eli_tramita.blade.php ENDPATH**/ ?>