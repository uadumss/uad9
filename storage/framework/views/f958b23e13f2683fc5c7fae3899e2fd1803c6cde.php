                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group col-md-12 justify-content-center">
                                    <button class="btn btn-sm btn-primary" type="button" onclick="enviar('form_busqueda','<?php echo e(url('buscar resolucion sancion')); ?>','panel_resolucion')">Buscar</button>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/no_atentado/sancionado/fe_resolucion.blade.php ENDPATH**/ ?>