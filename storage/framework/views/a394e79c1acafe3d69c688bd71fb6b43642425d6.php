                                ...
                                <table class="table table-sm table-hover sortable-table" width="100%" cellspacing="0" style="font-size: 0.8em" id="tablaDocumentos">
                                    ...
                                    <?php $__currentLoopData = $documentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <td><span class="badge badge-<?php echo e(\App\Helpers\UniversidadHelper::getTipoUniversidad($d->doc_universidad) === 'Pública' ? 'success' : (\App\Helpers\UniversidadHelper::getTipoUniversidad($d->doc_universidad) === 'Privada' ? 'warning' : 'info')); ?>"><?php echo e(\App\Helpers\UniversidadHelper::getTipoUniversidad($d->doc_universidad)); ?></span></td>
                                            <td>
...
<?php echo $__env->make('marco.pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\uad9\resources\views/funcionario/documento/l_documento.blade.php ENDPATH**/ ?>