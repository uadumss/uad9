            ...
            <div class="card-body">
                <div class="">
                    <div class="">
                        ...
                        <a href="<?php echo e(url('reporte dya')); ?>" class="btn btn-outline-info btn-sm text-dark mt-1 shadow-sm"><i class="fas fa-recycle"></i> Limpiar formulario</a> &nbsp;&nbsp;
...
<?php echo $__env->make('marco.pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uad9\resources\views/funcionario/reporte/fe_reporte.blade.php ENDPATH**/ ?>