<form action="<?php echo e(url('g_autoridad')); ?>" method="POST">
    ...
    <div class="modal-content border-bottom-primary">
        ...
        <div class="modal-body">
            ...
            <table class="table table-hover table-sm">
                <tr>
                    ...
                    <td class="border-bottom border-dark">
                        <input type="text" class="form-control form-control-sm border-0" name="nombre" value="<?php echo e($autoridad['aut_nombre']); ?>" />
                    </td>
                </tr>
                <tr>
                    <th class="text-right font-italic">Cargo :</th>
                    <td class="border-bottom border-dark">
                        <input type="text" class="form-control form-control-sm border-0" name="cargo" value="<?php echo e($autoridad['aut_cargo']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="border-bottom border-dark">
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm border-0" required pattern="[0-9]{1,4}" name="inicio" value="<?php echo e($autoridad['aut_inicio']); ?>" />
                ...
                <tr>
                    ...
                    <td class="border-bottom border-dark">
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm border-0" pattern="[0-9]{1,4}" required name="fin" value="<?php echo e($autoridad['aut_fin']); ?>"/>
            ...
            <input type="hidden" name="ca" value="<?php echo e($autoridad['cod_aut']); ?>">
        </div>
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/resoluciones/autoridad/fe_autoridad.blade.php ENDPATH**/ ?>