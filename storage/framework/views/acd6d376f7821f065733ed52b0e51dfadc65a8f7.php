<div class="modal-content border-bottom-primary">
    ...
    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php $__currentLoopData = $plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><?php echo e($p->plan_numero); ?></td>
                                        <td><?php echo e($p->plan_titulo); ?></td>
                                        <td class="text-right">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar plan - rr')): ?>
                                            <a href="#" class="btn btn-light btn-circle btn-sm text-primary" data-target="#editarPlan" data-toggle="modal" onclick="cargarDatos('<?php echo e(url('fe_plan/'.$p->cod_plan)); ?>','panel_editar_plan')"
                                               title="Editar plan"><i class="fas fa-edit"></i>
                                            </a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar plan - rr')): ?>
                                            <a href="#" class="btn btn-light btn-circle btn-sm text-danger" data-target="#eliminarPlan" data-toggle="modal" onclick="cargarDatos('<?php echo e(url('f_eli_plan/'.$p->cod_plan)); ?>','panel_eliminar_plan')"
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear plan - rr')): ?>
            ...
            <div class="col-md-5">
                <div class="card">
                    <form id="form_enviar_plan" action="<?php echo e(url('g_plan')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="bg-primary centrar_bloque p-1 col-md-7 rounded shadow">
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/resoluciones/codigo/l_plan.blade.php ENDPATH**/ ?>