    ...
    <div class="modal-content border-bottom-info">
        ...
        <div class="modal-body">
            <div class="alert alert-info">
                <strong>Tarea:</strong> <?php echo e($tarea->tar_nombre); ?>
            ...
            <?php if($designacionesActuales->count() > 0): ?>
                <table class="table table-sm table-hover">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $designacionesActuales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <?php if($d->foto): ?>
                                        <img src="<?php echo e(url('img/foto/'.$d->foto)); ?>" width="30" height="30" class="imgRedonda mr-2"/>
                                    <?php else: ?>
                                        <img src="<?php echo e(url('img/icon/sin foto'.$d->sexo.'.png')); ?>" width="30" height="30" class="imgRedonda mr-2"/>
                                    <?php endif; ?>
                                ...
                                <td class="text-center">
                                    ...
                                    ?>
                                    <span class="badge badge-success"><?php echo e($porcentaje); ?>%</span>
                                </td>
                                <td>
                                    <button class="btn btn-sm btn-warning text-white" data-toggle="modal" data-target="#marcarRetiro"
                                            onclick="prepararRetiro(<?php echo e($d->cod_des); ?>, '<?php echo e($d->name); ?>', <?php echo e($porcentaje); ?>)">
            ...
            <?php if($designacionesRetiradas->count() > 0): ?>
                <div class="overflow-auto" style="max-height: 300px;">
                    <table class="table table-sm table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $designacionesRetiradas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <?php if($d->foto): ?>
                                            <img src="<?php echo e(url('img/foto/'.$d->foto)); ?>" width="30" height="30" class="imgRedonda mr-2"/>
            ...
            <form id="form_nueva_asignacion" method="POST" action="<?php echo e(url('guardar_nueva_designacion')); ?>">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" name="id_funcionario" id="nuevoFuncionario" required>
                        ...
                        <?php $__currentLoopData = $funcionariosDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($f->id); ?>"><?php echo e($f->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <input type="hidden" name="cod_tar" value="<?php echo e($tarea->cod_tar); ?>">
                <input type="hidden" name="cod_act" value="<?php echo e($tarea->cod_act); ?>">
...
<div class="modal fade" id="marcarRetiro" tabindex="-1" role="dialog" aria-labelledby="marcarRetiroLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content border-bottom-warning">
            ...
            <form id="form_retiro" method="POST" action="<?php echo e(url('guardar_retiro_designacion')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/actividad/tarea/f_historial_designaciones.blade.php ENDPATH**/ ?>