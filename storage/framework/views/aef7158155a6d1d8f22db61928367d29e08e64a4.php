    ...
    <div class="modal-content border-bottom-primary shadow-lg">
                ...
                <div>
                    <table class="col-md-12 text-dark table table-sm">
                        ...
                        <tr>
                            ...
                            <td class="border-bottom border-dark"><?php echo e($frente->fre_nombre); ?></td>
                        </tr>
                        <tr>
                            <th class="text-right font-italic">Periodo : </th>
                            <td class="text-dark font-weight-bold">
                                <?php echo e(date('d/m/Y',strtotime($electo->ele_fecha_inicio))." - ".date('d/m/Y',strtotime($electo->ele_fecha_fin))); ?>
                        ...
                        <tr>
                            ...
                            <td class="border-bottom border-dark">
                                <?php if($electo->ele_tipo=='u'): ?>
                                    HCU
                                <?php else: ?>
                                    <?php if($electo->ele_tipo=='f'): ?>
                                        HCF
                                    <?php else: ?>
                                        <?php if($electo->ele_tipo=='c'): ?>
                                            HCC
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($electo->ele_fecha_renuncia): ?>
                                    <?php echo e(date('d/m/Y',strtotime($electo->ele_fecha_renuncia))); ?>
                                ...
                                <form id="form_renuncia">
                                    ...
                                    <input type="hidden" name="ce" value="<?php echo e($electo->cod_ele); ?>">
                                </form>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="modal-footer">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver datos consejero - cla')): ?>
                <button class="btn btn-primary btn-sm" type="button" data-dismiss="modal" onclick="enviar('form_renuncia','<?php echo e("g_renuncia"); ?>','panel_frente')">Guardar</button>
            <?php endif; ?>
        </div>

    </div>
</div>
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/claustro/datos_consejero.blade.php ENDPATH**/ ?>