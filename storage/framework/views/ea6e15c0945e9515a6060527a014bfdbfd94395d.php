            ...
            <div class="modal-body" style="font-size: 13px">
                ...
                <div class="row">
                    <div class="col-md-3 border rounded shadow-lg">
                        ...
                        <br/><br/>
                            <form id="form_general" action="<?php echo e(url('reporte servicios listas')); ?>" method="post" target="nuevo">
                                <?php echo csrf_field(); ?>
                                <table>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/reporte/listas/listas.blade.php ENDPATH**/ ?>