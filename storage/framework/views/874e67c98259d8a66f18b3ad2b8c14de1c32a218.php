    ...
    <div class="modal-content border-bottom-primary shadow-lg">
        ...
        <div class="modal-body">
            ...
            <hr class="sidebar-divider"/>
                            ...
                            <?php if($valorado): ?>
                                <?php //dd($valorado)?>
                        <?php if($valorado->dtra_entregado=='a' || $valorado->dtra_entregado=='t'): ?>
                        ...
                        <?php endif; ?>
                            ...
                            <table class="col-md-12">
                                <tr>
                                    ...
                                    <td class="text-dark text-left border-bottom pl-3"><?php echo e($valorado->per_apellido." ".$valorado->per_nombre); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right text-dark font-italic">CI:</th>
                                    <td class="text-dark text-left border-bottom pl-3"><?php echo e($valorado->per_ci); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right text-dark font-italic">Nombre trámite:</th>
                                    <td class="text-dark text-left border-bottom pl-3"><?php echo e($valorado->tre_nombre); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right  text-dark font-italic">Nro. Trámite:</th>
                                    <td class="text-dark text-left border-bottom pl-3"><?php echo e($valorado->dtra_numero_tramite.' / '.$valorado->dtra_gestion_tramite); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right text-dark font-italic">Nro. título:</th>
                                    <td class="text-dark text-left border-bottom pl-3"><?php echo e($valorado->dtra_numero." / ".$valorado->dtra_gestion); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right text-dark font-italic">Fecha solicitud:</th>
                                    <td class="text-dark text-left border-bottom pl-3"><?php echo e(date('d/m/Y H:i:s',strtotime($valorado->tra_fecha_solicitud))); ?></td>
                                </tr>
                                <tr>
                                    <th class="text-right text-dark font-italic">Fecha recojo:</th>
                                    <?php if($valorado->dtra_fecha_recojo!=''): ?>
                                        <td class="text-dark text-left border-bottom pl-3">
                                            <?php echo e(date('d/m/Y H:i:s',strtotime($valorado->dtra_fecha_recojo))); ?>
                                ...
                                <?php if($valorado->dtra_entregado=='a'): ?>
                                <tr>
                                    <th class="text-right text-dark font-italic">Entregado a :</th>
                                    <td class="text-dark text-left border-bottom border-danger pl-3"> <?php echo e($valorado->apo_apellido." ".$apo_nombre); ?> como <span class="p-1 bg-success rounded text-white font-italic font-weight-bold">APODERADO</span></td>
                                </tr>
                                <?php endif; ?>
                            </table>
                    <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/tra_legalizacion/valorado.blade.php ENDPATH**/ ?>