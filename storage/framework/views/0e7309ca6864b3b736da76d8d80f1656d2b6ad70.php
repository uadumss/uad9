<div class="modal-content border-bottom-primary">
    ...
    <div class="card shadow">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <table class="col-md-11 table">
                                        ...
                                        <tr>
                                            <th class="text-right font-italic">CI : </th>
                                            <td class="border-bottom border-dark"><?php echo e($sancionado->per_ci); ?></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right font-italic">Nombres : </th>
                                            <td class="border-bottom border-dark"><?php echo e($sancionado->per_apellido." ".$sancionado->per_nombre); ?></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right font-italic">Código SIS: </th>
                                            <td class="border-bottom border-dark"><?php echo e($sancionado->per_cod_sis); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <br/><br/>
                                    <div class="input-group p-2 rounded shadow float-right border">
                                        <a class="btn btn-sm btn-primary text-white" data-toggle="modal" data-target="#Modal2" onclick="cargarDatos('<?php echo e(url('obtener resolucion sancionado/'.$sancionado->cod_san)); ?>','panel_modal2')">+ Resolucion</a>
                                ...
                                <div class="col-md-6 shadow border">
                                    ...
                                    <table class="col-md-12">
                                        <tr>
                                            <th class="font-italic text-dark" colspan="2">Referencia :
                                                <textarea class="form-control form-control-sm" name="referencia"><?php echo e($sancionado->san_referencia); ?></textarea>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="font-italic text-dark" colspan="2">Sentencia :
                                                <textarea class="form-control form-control-sm" name="sentencia"><?php echo e($sancionado->san_sentencia); ?></textarea>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="font-italic text-dark" colspan="2">Resolución :
                                                <textarea class="form-control form-control-sm" name="resolucion"><?php echo e($sancionado->san_resolucion); ?></textarea>
                                            </th>
                                        </tr>
                                    </table>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary btn-sm" type="button" onclick="enviar('form_sancionado','<?php echo e(url('guardar sancionado noatentado')); ?>','panel_modal');cargarDatos('<?php echo e(url('actualizar lista sancionado noatentado')); ?>','panel_lista_sancionado')">Guardar</button>
        </div>
    </div>
</div>
<script>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/no_atentado/sancionado/fe_sancionado.blade.php ENDPATH**/ ?>