        ...
        <div class="modal-body">
            ...
            <div style="height: 650px;">
                    ...
                    <div class="col-md-5">
                        <div>
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                     <i class="fas fa-folder-open text-warning"></i>&nbsp;&nbsp;  <span class="text-dark font-italic"><?php echo e($act->act_nombre); ?></span>
                        ...
                        <div class="overflow-auto" style="height: 450px;">
                            <table class="table-hover table table-sm" border="0">
                                ...
                                <?php $__currentLoopData = $tar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><span class="font-weight-bold"><?php echo e($t['tar_nombre']); ?></span><br/>
                                            <span style="font-size: 0.8em">
                                        <span class="font-italic font-weight-bold">Tiempo : </span><span><?php echo e(date("d/m/Y", strtotime($t['tar_fi']))); ?> <?php if($t['tar_ff']!=''){?><?php echo e('-'.date("d/m/Y", strtotime($t['tar_ff']))); ?><?php }?></span> |
                                        <span class="font-italic font-weight-bold">Programado al : </span><span class="bg-primary text-white rounded font-weight-bolder" style="font-size: 0.8em;">&nbsp; <?php echo e($t['tar_por']); ?> % &nbsp;</span> <?php $por+=$t['tar_por']?>
                                        <br/>
                                                <!--ASIGNADO A-->
                                        <?php $__currentLoopData = $designados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $des): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($des->foto!=''): ?>
                                                                <img src="<?php echo e(url('img/foto/'.$des->foto)); ?>" class="imgRedonda centrar_bloque" width="40" height="40">
                                                            <?php else: ?>
                                                                <img src="<?php echo e(url('img/icon/sin foto'.$des->sexo.'.png')); ?>" class="imgRedonda centrar_bloque" width="40" height="40">
                                                            <?php endif; ?>
                                                            <?php echo e($des->name); ?>
                                        ...
                                        <td class="text-right">
                                            <?php if($t['tar_hab']=='t'): ?>
                                                <a href="#" onclick="cargarDatos('<?php echo e(url('habilitar tarea adm/'.$t['cod_tar'])); ?>','panel_actividad')" class="btn btn-light btn-circle btn-sm text-success">
                                                    <i class="fas fa-check"></i>
                                                </a>
                                            <?php else: ?>
                                                <a href="#" onclick="cargarDatos('<?php echo e(url('habilitar tarea adm/'.$t['cod_tar'])); ?>','panel_actividad')" class="btn btn-light btn-circle btn-sm text-dark">
                                                    <i class="fas fa-lock"></i>
                                                </a>
                                            <?php endif; ?>

                                            <a class="btn btn-light btn-circle btn-sm text-primary" data-target="#tarea" data-toggle="modal"
                                               onclick="cargarDatos('<?php echo e(url('datos tarea actividad adm/'.$t['cod_tar'])); ?>','panel_tarea')">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-light btn-circle btn-sm text-danger" data-target="#tarea" data-toggle="modal"
                                               onclick="cargarDatos('<?php echo e(url('f_eliminiar tarea adm/'.$t['cod_tar'])); ?>','panel_tarea')">
                ...
                <?php if($act->act_cot!='t'): ?>
                    <?php if($por==100): ?>
                        <span class="text-right text-dark  font-weight-bold pr-4" style="font-size: 0.75em">  ACTIVIDAD PROGRAMADA AL <?php echo e($por); ?> %</span>
                    <?php else: ?>
                        <span class="text-right text-danger font-weight-bold pr-4" style="font-size: 0.75em"> ACTIVIDAD PROGRAMADA AL <?php echo e($por); ?> %</span>
                    <?php endif; ?>
                <?php endif; ?>
        </div>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/session/administracion/act/listar_tarea.blade.php ENDPATH**/ ?>