<div class="modal-dialog modal-lg" role="document">
    <form action="<?php echo e(url('guardarActividad')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                    ...
                    <table class="col-md-12">
                        <tr>
                            ...
                            <td class="border-bottom border-dark" ><input class="form-control form-control-sm border-0" placeholder="Ingrese el nombre de la actividad" required
                                       name="nombre" value="<?php echo e($a['act_nombre']); ?>" /></td>
                        </tr>
                        <tr>
                            <th class="text-dark text-right">Fecha Inicio : </th>
                            <td class="border-bottom border-dark"><input class="form-control form-control-sm border-0" placeholder="Ingrese fecha de inicio" type="date" name="fi" value="<?php echo e($a['act_inicio']); ?>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea class="form-control form-control-sm border-0" rows="5" name="desc" id="desc"><?php echo e($a['act_desc']); ?></textarea>
                            </td>
                        </tr>
                    </table>
                    <input type="hidden" name="ca" value="<?php echo e($a['cod_act']); ?>">
                <?php else: ?>
                    <div class="bg-primary centrar_bloque p-1 col-md-5 rounded shadow">
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/actividad/f_editarActividad.blade.php ENDPATH**/ ?>