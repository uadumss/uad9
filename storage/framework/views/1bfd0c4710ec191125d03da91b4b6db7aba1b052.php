    ...
    <div class="col-md-4 border">
        <div>
            <table style="font-size:0.9em;" class="col-md-12">
                ...
                <?php endif; ?>
                <tr>
                    <th class="text-dark text-right font-italic">Diploma académico : </th> <td class="border-bottom border-dark"> &nbsp;&nbsp;<?php echo e($diplomaAcademicoMostrado); ?></td>
                </tr>
                <tr>
                    <th class="text-dark text-right font-italic">Título : </th> <td class="border-bottom border-dark"> &nbsp;&nbsp;<?php echo e($tituloMostrado); ?></td>
                </tr>
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/diplomas/buscar/detalleTitulo.blade.php ENDPATH**/ ?>