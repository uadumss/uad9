<div class="modal-dialog modal-xl" role="document" id="panel_docleg">
    <div class="modal-content border-bottom-danger shadow-lg">
        <form action="<?php echo e(url('e_tipo tramite')); ?>" method="post" id="form_eli_docleg">
        ...
        <div class="modal-body" style="font-size: 15px">
                ...
                <span class="font-italic">Esta seguro de modificar el tipo de trámite de
                    <span class="font-weight-bold text-dark"><?php echo e(App\Models\Funciones::tipo_tramite($tramita->tra_tipo_tramite)); ?>
                                ...
                                <table class="col-md-11">
                                    ...
                                    <tr class="border-bottom border-dark">
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(App\Models\Funciones::tipo_tramite($tramita->tra_tipo_tramite)); ?>
                                    ...
                                    <tr class="border-bottom border-dark">
                                        ...
                                        <td><?php echo e($tramita->tra_numero); ?></td>
                                    </tr>
                                    <tr class="border-bottom border-dark">
                                        <th class="text-dark font-italic text-right">Pertenece a : </th>
                                        <?php if($persona): ?>
                                            <td><?php echo e($persona->per_apellido." ".$persona->per_nombre); ?></td>
                                        <?php endif; ?>
                                    </tr>

                                </table>
                                <input type="hidden" name="ctra" value="<?php echo e($cod_tra); ?>">
                                <br/>
                                            ...
                                            <td>
                                                    <div id="tramite">
                                                        <select class="custom-select custom-select-sm border border-info" name="tramite">
                                                            <option value="<?php echo e($tramita->tra_tipo_tramite); ?>"><?php echo e(mb_strtoupper(App\Models\Funciones::tipo_tramite($tramita->tra_tipo_tramite))); ?></option>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/tra_legalizacion/f_cambiar_tramite.blade.php ENDPATH**/ ?>