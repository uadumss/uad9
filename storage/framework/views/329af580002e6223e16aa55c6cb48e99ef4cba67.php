<div class="modal-dialog modal-lg" role="document" id="">
    <div class="modal-content border-bottom-danger shadow-lg">
                            ...
                            <div>
                                <table class="table-hover col-md-12">
                                    <tr>
                                        ...
                                        <td class="border-bottom border-dark"><?php echo e($candidato->per_ci); ?></td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Nombre : </th>
                                        <td class="border-bottom border-dark"><?php echo e($candidato->per_nombre." ".$candidato->per_apellido); ?></td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Código SIS: </th>
                                        <td class="border-bottom border-dark"><?php echo e($candidato->per_cod_sis); ?></td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Cargo: </th>
                                        <td class="border-bottom border-dark"><?php echo e($candidato->carg_nombre); ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
        ...
        <div class="modal-footer">
            ...
            <?php if($candidato): ?>
                <form id="form_eli_candidato" method="POST" action="<?php echo e(url('eliminar convocatoria')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="cn" value="<?php echo e($candidato->cod_noa); ?>"/>
                </form>
                <button class="btn btn-danger btn-sm" type="button" onclick="enviar('form_eli_candidato','<?php echo e(url('eliminar candidato noatentado')); ?>','panel_noatentado');$('#Noatentado_agregar').modal('hide')">Eliminar</button>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/no_atentado/tramite/fe_eli_candidato.blade.php ENDPATH**/ ?>