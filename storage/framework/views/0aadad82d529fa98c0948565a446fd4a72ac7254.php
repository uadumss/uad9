            ...
            <div>
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <?php if($tipo=='da'): ?>
                            <form action="<?php echo e(url('l_titulo/'.$tomo['cod_tom'])); ?>" method="GET" class="mt-2 mb-2">
                                <div class="form-row align-items-end">
                                    <div class="col-md-3">
                                        <label class="small font-weight-bold text-dark mb-1">Buscar persona o CI</label>
                                        <input type="text" class="form-control form-control-sm border border-info" name="q" value="<?php echo e($filtrosTitulo['q'] ?? ''); ?>" placeholder="Apellido, nombre o CI">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="small font-weight-bold text-dark mb-1">Nro. diploma</label>
                                        <input type="text" class="form-control form-control-sm border border-info" name="nro" value="<?php echo e($filtrosTitulo['nro'] ?? ''); ?>" placeholder="Ej. 12345">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control form-control-sm border border-info" name="car">
                                            ...
                                            <?php $__currentLoopData = $carrera; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->cod_car); ?>" <?php echo e(($filtrosTitulo['car'] ?? '')==$c->cod_car ? 'selected' : ''); ?>><?php echo e($c->fac_abreviacion." - ".$c->car_nombre); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control form-control-sm border border-info" name="mod">
                                            ...
                                            <?php $__currentLoopData = $modalidad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($m['cod_mod']); ?>" <?php echo e(($filtrosTitulo['mod'] ?? '')==$m['cod_mod'] ? 'selected' : ''); ?>><?php echo e($m['mod_nombre']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="submit" class="btn btn-sm btn-primary btn-block">Filtrar</button>
                                        <a href="<?php echo e(url('l_titulo/'.$tomo['cod_tom'])); ?>" class="btn btn-sm btn-outline-secondary btn-block mt-1">Limpiar</a>
                                    </div>
                                </div>
                            </form>
                        <?php endif; ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-hover border border-right" id="dataTable" width="100%" cellspacing="0" data-page-length="<?php echo e($tipo=='da' ? 100 : 500); ?>" data-search-delay="<?php echo e($tipo=='da' ? 350 : 0); ?>" data-defer-render="<?php echo e($tipo=='da' ? 1 : 0); ?>">
                                <thead>
...
<?php echo $__env->make('marco/pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/diplomas/titulo/l_titulo.blade.php ENDPATH**/ ?>