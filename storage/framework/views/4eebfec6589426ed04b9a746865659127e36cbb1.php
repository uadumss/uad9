                    ...
                    <?php if(!$tramite_noatentado): ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 table">
                                    ...
                                    <div class="col-md-12">
                                        <button class="btn btn-primary btn-sm float-right" type="button" onclick="enviar('form_tramite','<?php echo e(url('guardar tramite convocatoria noatentado')); ?>','panel_noatentado');cargarDatos('<?php echo e(url('actualizar lista tramite convocatoria/'.$cod_con)); ?>','panel_lista_tramites')"> Guardar</button>
                                    </div>
                                </div>
                            </div>
                    <?php else: ?>
                            ...
                            <div class="col-md-5">
                                ...
                                <table class="col-md-12 text-dark table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom  input-group">
                                            <div class="input-group">
                                                <input class="form-control form-control-sm border" required name="control"  value="<?php echo e($tramite_noatentado->dtra_control); ?>"/>
                                                <span class="text-primary font-weight-bold font-italic"> Nro. Control Reintegro : &nbsp;</span>
                                                <input class="form-control form-control-sm border" required name="reintegro"  value="<?php echo e($tramite_noatentado->dtra_valorado_reintegro); ?>"/>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
                                    ...
                                    <input type="hidden" name="cc" value="<?php echo e($tramite_noatentado->cod_con); ?>">
                                </form>
                                            ...
                                            <table class="table table-sm table-hover" id="lista" width="100%" cellspacing="0" style="font-size: 12px">
                                                ...
                                                <?php $__currentLoopData = $noatentados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr class="alert-danger">
                                                        ...
                                                        <td>
                                                            <?php if($sancionado && $sancionado->cod_res!=''): ?>
                                                                <a href="" class="btn btn-circle btn-light btn-sm text-danger border" data-toggle="modal" data-target="#Noatentado_agregar"
                                                                   onclick="cargarDatos('<?php echo e(url('ver datos resolucion/'.$sancionado->cod_res)); ?>','panel_agregar')" title="Ver detalle de la resolución"> <i class="fas fa-file-pdf"></i>
                                                                </a>
                                                            <?php endif; ?>
                                                            <?php if($tramite_noatentado->dtra_generado==''): ?>
                                                                <a href="#"  class="btn btn-sm btn-light btn-circle" data-toggle="modal" data-target="#Noatentado_agregar" title="Eliminar candidato"
                                                                   onclick="cargarDatos('<?php echo e(url('formulario eliminar candidato/'.$n->cod_noa)); ?>','panel_agregar');
                                                                    cargarDatos('<?php echo e(url('actualizar lista tramite convocatoria/'.$cod_con)); ?>','panel_lista_tramites');">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar tramite - noa')): ?>
                                        <?php if($tramite_noatentado->dtra_qr==''): ?>
                                            <a href="#Noatentado_agregar" class="btn btn-sm btn-primary" data-toggle="modal"
                                               onclick="cargarDatos('<?php echo e(url('editar candidato convocatoria/'.$tramite_noatentado->cod_dtra.'/0')); ?>','panel_agregar')">+ Candidato</a> &nbsp; &nbsp;
                                            <a href="#Noatentado_agregar" class="btn btn-sm btn-success" data-toggle="modal"
                                               onclick="cargarDatos('<?php echo e(url('agregar candidato excel convocatoria/'.$tramite_noatentado->cod_dtra)); ?>','panel_agregar')">+ Exportar de exel</a> &nbsp; &nbsp;
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/no_atentado/tramite/fe_noatentado_convocatoria.blade.php ENDPATH**/ ?>