            ...
            <div class="">
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#panel_duplicados" role="tab"
                       aria-controls="home" onclick="cargarDatos('<?php echo e(url('lista duplicados/total')); ?>','panel_duplicados')">Duplicados completos</a>
                    <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#panel_duplicados" role="tab"
                       aria-controls="profile" onclick="cargarDatos('<?php echo e(url('lista duplicados/apellido')); ?>','panel_duplicados')">Duplicado por apellido</a>
                    <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#panel_duplicados" role="tab"
                       aria-controls="messages" onclick="cargarDatos('<?php echo e(url('lista duplicados/nombre')); ?>','panel_duplicados')">Duplicado por nombre</a>
                    <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#panel_duplicados" role="tab"
                       aria-controls="settings" onclick="cargarDatos('<?php echo e(url('lista duplicados/ci')); ?>','panel_duplicados')">Duplicado Por CI</a>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/session/administracion/persona/duplicado/f_duplicados.blade.php ENDPATH**/ ?>