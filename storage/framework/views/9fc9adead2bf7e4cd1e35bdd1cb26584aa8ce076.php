    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 alert-primary">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <?php if(!isset($primeraBusqueda) && count($resultado)>0): ?>
                    <?php
                        $queryExcel=(isset($filtrosExcel) && count($filtrosExcel)>0) ? ('?'.http_build_query($filtrosExcel)) : '';
                    ?>
                    <a href="<?php echo e(url('exportar busqueda resolucion excel').$queryExcel); ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
...
<?php echo $__env->make('marco/pagina', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/resoluciones/buscar/f_buscar_resolucion.blade.php ENDPATH**/ ?>