<div class="modal-dialog modal-lg" role="document" id="panel_docleg">
    <div class="modal-content border-bottom-danger shadow-lg">
        ...
        <div class="modal-body">
            <form action="<?php echo e(url('corregir_docleg')); ?>" method="post" id="form_corregir_docleg">
                <?php echo csrf_field(); ?>
                <span class="font-italic">Esta seguro de editar el trámite de legalización : </span><br/><br/>
                <div class="row">
                    <div class="alert-danger shadow text-center centrar_bloque col-md-9 p-2" >
                        <div>
                                <table class="col-md-12">
                                    ...
                                    <tr>
                                        <th class="text-right">Nro. Trámite:</th>
                                        <th class="text-dark text-left border-bottom border-danger pl-3"><?php echo e($docleg->dtra_numero_tramite.' / '.$docleg->dtra_gestion_tramite); ?></th>
                                    </tr>
                                </table>
        ...
        <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                <button class="btn btn-danger" data-dismiss="modal" onclick="guardarDatos('<?php echo e(url("corregir_docleg")); ?>','panel_traleg','form_corregir_docleg')"> Editar</button>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/tra_legalizacion/fe_corregir_docleg.blade.php ENDPATH**/ ?>