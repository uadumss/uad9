                    ...
                    <hr class="sidebar-divider text-bg-dark">
                        <div class="row">
                            ...
                            <div class="col-md-6 shadow border p-2">
                                ...
                                <div class="overflow-auto" style="height: 450px">
                                    <table class="table-sm table">
                                        ...
                                        <?php $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($i++); ?></td>
                                                <td><?php echo e($d->dsan_detalle); ?></td>
                                                <td>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar detalle sancionado - noa')): ?>
                                                        <a href="#" class="btn btn-light btn-circle btn-sm text-primary" data-toggle="modal" data-target="#Modal2"
                                                           onclick="cargarDatos('<?php echo e(url("editar detalle sancion/".$sancionado->cod_san."/".$d->cod_dsan)); ?>','panel_modal2')"
                                                           title="Editar detalle"><i class="fas fa-edit"></i>
                                                        </a>
                                                    <?php endif; ?>

                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar detalle sancionado - noa')): ?>
                                                        <a class="btn btn-light btn-circle btn-sm text-danger" data-target="#Modal2" data-toggle="modal"
                                                           onclick="cargarDatos('<?php echo e(url("formulario eliminar detalle sancion/".$d->cod_dsan)); ?>','panel_modal2')"
                                ...
                                <br/>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear detalle sancioando - noa')): ?>
                                <a class="btn btn-sm btn-primary text-white" data-toggle="modal" data-target="#Modal2"
                                   onclick="cargarDatos('<?php echo e(url('editar detalle sancion/'.$sancionado->cod_san.'/0')); ?>','panel_modal2')">+ Detalle</a>
                                <?php endif; ?>
                            </div>
                        </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/servicios/no_atentado/sancionado/fe_sancion.blade.php ENDPATH**/ ?>