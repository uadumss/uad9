        ...
        <table class="table-hover col-md-11">
            <tr>
                ...
                <td class="border-bottom border-dark">
                    <input type="text" class="form-control form-control-sm border-0 col-md-12" name="nombre" required value="<?php echo e($usuario->name); ?>"/>
                </td>
            </tr>
            <tr>
                <th class="text-right font-italic">Cédula de Identidad :</th>
                <td class="border-bottom border-dark">
                    <input type="text" class="form-control form-control-sm border-0 col-md-12" name="ci" required value="<?php echo e($usuario->ci); ?>"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="border-bottom border-dark">
                    <input type="text" class="form-control form-control-sm border-0 col-md-12" name="login-i" disabled value="<?php echo e($usuario->email); ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td class="border-bottom border-dark">
                    <select class="custom-select custom-select-sm" name="cargo">
                        <option value="<?php echo e($usuario->cargo); ?>"><?php echo e($usuario->cargo); ?></option>
            ...
            <tr>
                ...
                <td class="border-bottom border-dark"><textarea class="form-control" rows="2" required name="contacto" id="contacto"><?php echo e($usuario->contacto); ?></textarea>
                </td>
            </tr>
            <tr>
                <th class="text-right font-italic">Dirección : </th>
                <td class="border-bottom border-dark"><textarea class="form-control" rows="3" required name="direccion" id="direccion"><?php echo e($usuario->direccion); ?></textarea>
                </td>
            </tr>
        </table>
    </div>
    <div class="col-md-5">
        ...
        <div class="col-md-8">
            ...
            <div id="prevista1" class="centrar_bloque col-md-6">
                <?php if($usuario->foto!=''): ?>
                    <img id="imgSalida" class="imgRedonda" width="150" height="150" src="<?php echo e(url('img/foto/'.$usuario->foto)); ?>" />
                <?php else: ?>
                    <img id="imgSalida" class="imgRedonda" width="150" height="150" src="<?php echo e(url('img/icon/fotoM.png')); ?>" />
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<input type="hidden" name="login" value="<?php echo e($usuario->email); ?>">
...
<?php /**PATH C:\xampp\htdocs\uad9\resources\views/session/f_editar_usuario.blade.php ENDPATH**/ ?>