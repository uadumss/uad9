                ...
                <table class="table-hover col-md-12" >
                    <tr>
                        ...
                        <td class="border-bottom border-dark">
                            <input type="text" class="form-control form-control-sm border-0" name="codigo" required value="<?php echo e($codigo->carch_numero); ?>" />
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right font-italic"> Título :</th>
                        <td class="border-bottom border-dark">
                            <input type="text" class="form-control form-control-sm border-0" name="titulo" required value="<?php echo e($codigo->carch_titulo); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right font-italic"> Plan :</th>
                        <td class="border-bottom border-dark">
                            <span class="text-danger font-weight-bold">&nbsp;&nbsp;<?php echo e($plan->plan_numero); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right font-italic"> Temas :</th>
                        <td class="border-bottom border-dark">
                            <textarea class="form-control" name="desc" id="desc1" cols="10" rows="5"><?php echo e($codigo->carch_desc); ?></textarea>
                        </td>
                    </tr>
                </table>
                <input type="hidden" name="cc" value="<?php echo e($codigo->cod_carch); ?>">
            </div>
...
<?php /**PATH C:\Users\Pc\Desktop\UAD9V2\uad9\resources\views/resoluciones/codigo/fe_codigo.blade.php ENDPATH**/ ?>