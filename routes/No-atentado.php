...
//=========================== Tramites con convocatoria
    ...
    Route::post('validar pago noatentado/{cod_con}',[TramiteNoAtentadoController::class,'validar_pago_noatentado'])->middleware(['permission:crear tramite - noa|editar tramite - noa']);
