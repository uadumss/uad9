        ...
        <div class="card-body">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <div>
                        <ul>
                            <li><a href="#" data-toggle="modal" data-target="#reporte" onclick="cargarDatos('{{url('modal reporte servicios/personal')}}','panel_reporte')">1. Reporte mediante datos personales</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#reporte" onclick="cargarDatos('{{url('modal reporte servicios/general')}}','panel_reporte')">2. Reporte general de tr&aacute;mites</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#reporte" onclick="cargarDatos('{{url('modal reporte servicios/estadistico')}}','panel_reporte')">3. Reporte Estadistico</a></li>


                                <li><a href="#" data-toggle="modal" data-target="#reporte" onclick="cargarDatos('{{url('modal reporte servicios/listas')}}','panel_reporte')">4. Reporte en PDF de trámites mediante fecha </a></li>
                                <li><a href="#" data-toggle="modal" data-target="#reporte" onclick="cargarDatos('{{url('modal reporte servicios/entregas')}}','panel_reporte')">5. Reporte en PDF de entrega de trámites</a></li>
