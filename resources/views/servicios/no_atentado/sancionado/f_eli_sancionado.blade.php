<div class="modal-dialog modal-lg" role="document" id="">
    <div class="modal-content border-bottom-danger shadow-lg">
                            ...
                            <div>
                                <table class="col-md-12">
                                    <tr>
                                        ...
                                        <td class="border-bottom border-dark text-left">{{$sancionado->per_ci}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Nombre : </th>
                                        <td class="border-bottom border-dark text-left">{{$sancionado->per_nombre." ".$sancionado->per_apellido}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Referencia: </th>
                                        <td class="border-bottom border-dark text-left">{{$sancionado->san_referencia}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Sentencia: </th>
                                        <td class="border-bottom border-dark text-left">{{$sancionado->san_sentencia}}</td>
                                    </tr>
                                    <tr>
                                        <th class="text-right font-italic text-dark">Resolución: </th>
                                        <td class="border-bottom border-dark text-left">{{$sancionado->san_resolucion}}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
        ...
        <div class="modal-footer">
            ...
            @if($sancionado && $eliminar==1)
                <form id="form_eli_sancionado" method="POST" action="{{url('eliminar sancionado noatentado')}}">
                    @csrf
