<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content border-bottom-primary shadow-lg">
        ...
        <div class="modal-body" style="font-size: 14px">
            ...
            <div class="row">
                ...
                <div class="col-md-6 shadow overflow-auto p-3" style="height: 450px;" >
                    ...
                    <br/><br/>
                    <button class="btn- btn-sm btn-primary" onclick="cargarDatos('{{url('obtener unidad convocatoria noatentado/unidad/'.$convocatoria->cod_con)}}','panel_unidad')">Unidad </button>
                    <button class="btn- btn-sm btn-primary" onclick="cargarDatos('{{url('obtener unidad convocatoria noatentado/facultad/'.$convocatoria->cod_con)}}','panel_unidad')">Facultad </button>
                    <button class="btn- btn-sm btn-primary" onclick="cargarDatos('{{url('obtener unidad convocatoria noatentado/carrera/'.$convocatoria->cod_con)}}','panel_unidad')">Carrera </button>
                </div>
            </div>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary btn-sm" type="button" onclick="enviar('form_unidad','{{url('guardar unidad convocatoria noatentado')}}','panel_convocatoria');$('#modal_agregar').modal('hide')">Guardar</button>
        </div>
    </div>
</div>
