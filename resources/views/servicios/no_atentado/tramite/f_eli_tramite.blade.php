<div class="modal-dialog modal-lg" role="document" id="">
    <div class="modal-content border-bottom-danger shadow-lg">
        <div class="modal-header bg-danger">
            <h5 class="modal-title text-white font-weight-bolder" id="exampleModalLabel"><i class="fas fa-trash-alt"></i>&nbsp;&nbsp;ELIMINAR TRÁMITE</h5>
                            ...
                            <div>
                                <table class="table-hover col-md-12">
                                    <tr>
                                        ...
                                        <td class="text-left border-bottom border-dark">{{$documento_tramite->dtra_numero_tramite."/".$documento_tramite->dtra_gestion_tramite}}</td>
                                    </tr>
                                    <tr>
        ...
        <div class="modal-footer">
            ...
            @if($eliminar==1)
                <form id="form_eli_tramite" method="POST" action="{{url('eliminar tramite convocatoria noatentado')}}">
                    @csrf
                    <input type="hidden" name="cd" value="{{$documento_tramite->cod_dtra}}"/>
                </form>
