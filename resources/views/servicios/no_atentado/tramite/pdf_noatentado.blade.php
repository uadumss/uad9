...
<body id="page-top">
@switch($tramite_noatentado->dtra_glosa_posicion)
    @case (0)
...
<div class="row">
    ...
    <div>
        ...
        <table>
            <tr>
                <td style="padding: 5px;"><img width="130" height="130" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(100)->generate('http://http://www.archivos.umss.edu.bo/verificar_tramite/index.php?q='.$tramite_noatentado->dtra_qr)) !!}"></td>
                <td style="padding-left: 5px;">
                    <span style="font-weight: bold; text-align: justify-all">{{$tramite_noatentado->dtra_titulo}}</span><br/><br/>
                    <span style="font-style: italic; font-weight: bold">{{"ARCH ".$tramite_noatentado->dtra_numero_tramite."/".$tramite_noatentado->dtra_gestion_tramite}}</span><br/>
                </td>
            </tr>
        </table>
        ...
        <div style="text-align: center">
            {{$tramite_noatentado->dtra_fecha_literal}}
        </div>
    </div>
</div>
</body>
