<div class="modal-dialog modal-lg" role="document" id="panel_tramite_apostilla">
    <div class="modal-content border-bottom-primary shadow-lg">
        ...
        <div class="modal-body" style="font-size: smaller">
            ...
            <form id="form_excel" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" name="cd" value="{{$cod_dtra}}">
                </div>
            </form>
            <br/>
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="enviarExcel('{{url('guardar candidato excel convocatoria')}}','panel_noatentado');cargarDatos('{{url('actualizar lista tramite convocatoria/'.$tramite_noatentado->cod_con)}}','panel_lista_tramites')">Guardar</button>
        </div>
    </div>
</div>
<script>
