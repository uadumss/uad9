<div class="modal-dialog modal-lg" role="document" id="panel_docleg">
    <div class="modal-content border-bottom-danger shadow-lg">
        ...
        <div class="modal-body">
            <form action="{{url('corregir_docleg')}}" method="post" id="form_corregir_docleg">
                @csrf
                        ...
                        <div>
                                <table class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-dark text-left border-bottom border-danger pl-3">{{$docleg->dtra_numero_tramite.' / '.$docleg->dtra_gestion_tramite}}</th>
                                    </tr>
                                </table>
        ...
        <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                <button class="btn btn-danger" data-dismiss="modal" onclick="guardarDatos('{{url("corregir_docleg")}}','panel_traleg','form_corregir_docleg')"> Editar</button>
        </div>
    </div>
</div>
