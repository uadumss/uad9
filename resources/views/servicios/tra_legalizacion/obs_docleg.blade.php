<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content border-bottom-danger shadow-lg">
                ...
                <form method="post" id="form_g_obs_docleg">
                    ...
                    <table class="col-md-11">
                        <tr>
                            ...
                            <td class="border-bottom border-dark">{{$docleg->tre_nombre}}</td>
                        </tr>
                        ...
                        @else
                            <tr>
                                <th class="text-right font-italic text-danger">Observación : </th>
                                <td class="border-bottom border-dark">
                                    <textarea class="form-control" name="obs">{{$docleg->dtra_obs}}</textarea>
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="modal-footer">
            ...
            @if($docleg->dtra_falso!='t')
                <button class="btn btn-sm btn-danger" onclick="guardarDatos('{{url("g_obs_docleg")}}','panel_traleg','form_g_obs_docleg')" data-dismiss="modal">Guardar</button>
            @endif
        </div>
    </div>
</div>
