<div class="modal-dialog modal-lg" role="document" id="panel_docleg">
    <div class="modal-content border-bottom-primary shadow-lg">
                            ...
                            <div>
                                <table class="col-md-12">
                                    <tr>
                                        ...
                                        <th class="text-dark text-left border-bottom border-dark pl-3">{{$tramite->tre_nombre}}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-right">Nro. título:</th>
                                        <th class="text-dark text-left border-bottom border-dark pl-3">{{$docleg->dtra_numero." / ".$docleg->dtra_gestion}}</th>
                                    </tr>
                            ...
                            <div>
                                <table class="col-md-12">
                                    <tr>
                                        ...
                                        <th class="text-dark text-left border-bottom border-dark pl-3">{{$documento->dcon_doc}}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-right">Nro. título:</th>
                                        <th class="text-dark text-left border-bottom border-dark pl-3">{{$docleg->dtra_numero." / ".$docleg->dtra_gestion}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-dark text-left border-bottom border-dark pl-3">
                                            {{\App\Models\Funciones::nombre_titulo($docleg->dtra_buscar_en)}}
                                        </th>
                                    </tr>
                                </table>
                                <input type="hidden" name="cdtra" value="{{$docleg->cod_dtra}}">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" data-dismiss="modal" onclick="guardarDatos('{{url("g_busqueda_encontrado")}}','panel_traleg','form_eli_docleg')"> Registrar</button>
        </div>
