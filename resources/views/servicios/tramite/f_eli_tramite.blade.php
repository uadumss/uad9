<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content border-bottom-danger">
        <form action="{{url('eli_tramite')}}" method="post">
            @csrf
            ...
            <div class="modal-body">
                @if($tramites[0]->cantidad==0 && sizeof($glosa)==0)
                            ...
                            <div>
                                <table class="text-dark col-md-12" >
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-dark text-left border-bottom border-danger pl-3">{{$tramite->tre_costo}}</th>
                                    </tr>
                                    <tr>
                                        <th class="text-right">Descripción:</th>
                                        <th class="text-dark text-left border-bottom border-danger pl-3">{{$tramite->tre_desc}}</th>
                                    </tr>
                                </table>
