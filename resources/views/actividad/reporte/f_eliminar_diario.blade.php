...
<div class="modal-content border-bottom-danger">
                ...
                <div class="font-weight-bold alert-danger shadow text-center centrar_bloque col-md-9 p-3" id="panel_e_titulo">
                    <table class="col-md-12">
                        <tr>
                            ...
                            <th class="text-dark text-left border-bottom border-danger pl-3">{{date('d/m/Y',strtotime($diario->dia_fech))}}</th>
                        </tr>
                        <tr>
                            <th class="text-right"> De la Tarea : </th>
    ...
    <div class="modal-footer">
        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
            ...
            <form action="{{url('eliminar diario')}}" method="POST">
                @csrf
