            ...
            <div class="card-header py-3 alert-primary col-md-12">
                <div class="d-sm-flex align-items-center col-md-12">
                    ...
                    <div class="col-md-6 text-right">
                        <!-- Botones movidos al formulario de conformidad -->
                    </div>
                </div>
            </div>
                    ...
                    <div class="">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-info text-white">
                                <h6 class="mb-0">Formulario de conformidad</h6>
                            </div>
                            <div class="card-body">
                                <form id="formConformidad" method="POST" action="{{ url('guardar-conformidad') }}">
                                    ...
                                    <div class="form-row mt-3">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#documento" 
