            ...
            <br/>
                <table class="table table-sm shadow-sm rounded table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($a['act_hab']=='t')
                                <a onclick="cargarDatos('{{url('habilitar actividad adm/'.$a['cod_act'])}}','panel')" class="btn btn-light btn-circle btn-sm text-success">
                                    <i class="fas fa-check"></i>
                                </a>
                            @else
                                <a onclick="cargarDatos('{{url('habilitar actividad adm/'.$a['cod_act'])}}','panel')" class="btn btn-light btn-circle btn-sm text-dark">
                                    <i class="fas fa-lock"></i>
                                </a>
                            @endif
                            <a href="#" class="btn btn-light btn-circle btn-sm text-primary" data-target="#actividad" data-toggle="modal"
                               onclick="cargarDatos('{{url("datos actividad adm/".$a['cod_act'].'/'.$id)}}','panel_actividad')">
                                <i class="fas fa-edit"></i>
                            </a>

                            <a href="#" class="btn btn-light btn-circle btn-sm text-danger" data-target="#actividad" data-toggle="modal"
                                   onclick="cargarDatos('{{url("f_eliminar actividad adm/".$a['cod_act'])}}','panel_actividad')">
                                <i class="fas fa-trash"></i>
                            </a>
                        </td>
                        <td>
                            <a href="#" class="btn btn-light btn-circle btn-sm text-dark" data-target="#actividad" data-toggle="modal"
                               onclick="cargarDatos('{{url('listar tareas actividad adm/'.$a['cod_act'])}}','panel_actividad')">
