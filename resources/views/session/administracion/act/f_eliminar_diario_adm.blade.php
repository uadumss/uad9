...
<div class="modal-content border-bottom-danger">
            ...
            <div class="alert-danger shadow text-center centrar_bloque col-md-9 p-3" id="panel_e_titulo">
                <table class="col-md-12">
                    <tr>
                        ...
                        <td class="text-dark text-left border-bottom border-danger pl-3">{{date('d/m/Y',strtotime($diario->dia_fech))}}</td>
                    </tr>
                    <tr>
                        <th class="text-right"> Usuario: </th>
                        <td class="text-dark text-left border-bottom border-danger pl-3">
                            @if($usuario->foto!='')
                                <img src="{{url('img/foto/'.$usuario->foto)}}" width="40" height="40" class="imgRedonda float-left"/>
                            @endif
                            {{$usuario->name}}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-dark text-left border-bottom border-danger pl-3">{{$tarea->tar_nombre}}</td>
                    </tr>
                    <tr>
                        <th class="text-right"> Reporte: </th>
                        <td class="text-dark text-left border-bottom border-danger pl-3">{{$diario->dia_reporte}}</td>
                    </tr>
                </table>
            </div>
    ...
    <div class="modal-footer">
        ...
        <form id="form_eliminar_diario">
            ...
            <button class="btn btn-danger btn-sm" type="button" onclick="enviar('form_eliminar_diario','{{url('eliminar diario adm')}}','panel_diario');$('#observacion').modal('hide');"> Eliminar</button>
    </div>
</div>
</div>
