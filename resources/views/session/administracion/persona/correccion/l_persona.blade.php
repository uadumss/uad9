                            ...
                            <div class="col-md-4 m-5">
                                <div>
                                    <table>
                                        ...
                                        <tr>
                                            <td class="p-2">
                                                <button onclick="enviar('form_corregir','{{url("fe_persona")}}','panel_correccion')" type="button"  class="focus btn btn-primary btn-sm text-white"><i class="fas fa-search"></i> Buscar</button>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
...
<script>
    ...
    nombre.addEventListener("keydown", (evento) => {
        if (evento.key == "Enter") {
            ...
            enviar('form_corregir','{{url("fe_persona")}}','panel_correccion');
            return false;
        }
    });
</script>
