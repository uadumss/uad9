<div class="modal-content border-bottom-danger">
    <div class="modal-header bg-danger">
        @if($a_cargo->ac_hab=='t')
            <h5 class="modal-title text-white" id="exampleModalLabel"> &nbsp;&nbsp;Deshabilitar Asignacion</h5>
        @else
            <h5 class="modal-title text-white" id="exampleModalLabel"> &nbsp;&nbsp;Habilitar Asignacion</h5>
        @endif
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-danger" type="button" data-dismiss="modal" onclick="enviar('form_hab_asignacion','{{url("habilitar asignacion funcionario")}}','panel')">Aceptar</button>
    </div>
</div>
