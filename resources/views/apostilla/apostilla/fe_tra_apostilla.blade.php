...
<form action="{{url('guardar documento apostilla')}}" method="POST">
    @csrf
    ...
    <div class="modal-content border-bottom-primary">
        ...
        <div class="modal-body">
            ...
            @else
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="table-hover col-md-12">
                                        <tr>
                                            ...
                                            <td class="border-bottom border-dark">
                                                <input class="form-control form-control-sm border-0" placeholder=""
                                                       required name="nombre" value="{{$tramite['lis_nombre']}}" /></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right font-italic">Alias : </th>
                                            <td class="border-bottom border-dark">
                                                <input class="form-control form-control-sm border-0" placeholder=""
                                                       required name="alias" value="{{$tramite['lis_alias']}}" /></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right font-italic">N° Cuenta : </th>
                                            <td class="border-bottom border-dark">
                                                <input class="form-control form-control-sm border-0" required name="cuenta" value="{{$tramite['lis_cuenta']}}"/></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right font-italic">Monto (Bs.): </th>
                                            <td class="border-bottom border-dark">
                                                <input class="form-control form-control-sm border-0" required name="monto" pattern="[0-9]{1,4}" value="{{$tramite['lis_monto']}}"/></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th class="text-right font-italic">Descripción : </th>
                                            <td class="border-bottom border-dark">
                                                <textarea class="form-control border-0" rows="5" name="desc" id="desc">{{$tramite['lis_desc']}}</textarea>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <input type="hidden" name="cl" value="{{$tramite['cod_lis']}}">
            @endif
        </div>
