    ...
    <div class="modal-body" style="font-size: smaller">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <br/>
                <br/>
                    <a class="btn btn-sm btn-primary text-white" onclick="enviar('form_busqueda_apostilla','{{url('buscar tramite apostilla')}}','panel_resultado_busqueda')">Buscar</a>
            </div>
