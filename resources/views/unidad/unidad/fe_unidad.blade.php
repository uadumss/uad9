<form action="{{url('guardar unidad/')}}" method="POST" id="form_importar" enctype="multipart/form-data">
    @csrf
                ...
                @else
                    ...
                    <table class="col-md-12">
                        <tr>
                            <th class="text-right font-italic ">Nombre de la unidad:</th>
                            <td class="border-bottom border-dark ">
                                <input type="text" class="form-control form-control-sm border-0" required name="nombre" value="{{$unidad->uni_nombre}}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="text-right font-italic">Nombre corto:</th>
                            <td class="border-bottom border-dark">
                                <input type="text" class="form-control form-control-sm border-0" name="corto" value="{{$unidad->uni_abreviacion}}"/>
                            </td>
                        </tr>
                        <tr>
                            <th class="text-right font-italic">Tipo de unidad:</th>
                            <td class="border-bottom border-dark">
                                <select class="custom-select custom-select-sm" name="nivel">
                                    @if($unidad->uni_nivel!='')
                                        <option value="{{$unidad->uni_nivel}}">{{$unidad->uni_nivel}}</option>
                                    @endif
                                    <option></option>
                                    <option value="DIRECCION">DIRECCION</option>
                                    <option value="DEPARTAMENTO">DEPARTAMENTO</option>
