<div class="modal-dialog modal-lg" role="document">
    <form action="{{url('verificar importacion temas/')}}" method="POST" id="form_importar" enctype="multipart/form-data">
        @csrf
                ...
                <div class="shadow-sm rounded p-2">
                    ...
                    <table class="col-md-12">
                        <tr>
                            ...
                            <td>
                                <span class="text-danger font-italic font-weight-bold" style="font-size: 12px">[AÑO, NUMERO, TIPO]</span>
                            </td>
                        </tr>
                        <tr>
