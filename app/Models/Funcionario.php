...
class Funcionario extends Model
{
    ...
    protected $fillable=['cod_nac','fun_apellido','fun_nombre','fun_ci','fun_telefonos','fun_email','fun_sexo','fun_fecha_ingreso','fun_nacionalidad',
        ...
        'dt_universidad','fun_actualizado','fun_folder','fun_fecha_ingreso_u','fun_fecha_folder','fun_cargo','fun_tipo_contrato','fun_fecha_importacion','fun_habilitado','fun_env_dpa','fun_pdf_env_dpa'];
    protected $primaryKey='cod_fun';
    protected $table='doc_adm.funcionarios';
    protected $casts=[
        'fun_habilitado'=>'boolean',
        'fun_env_dpa'=>'boolean',
        'fun_fecha_importacion'=>'datetime',
    ];
}
